...
export const en = {
  ...
  sshConnections: {
    ...
    editDialogDescription: "Change the host, port, username, or key.",
    privateKeyEditPlaceholder: "Leave blank to keep the existing key",
  ...
  commandRules: {
    ...
    dialogDescription:
      "The rules this connection's ssh_execute calls are checked against, evaluated top to bottom — the first matching rule wins. Whether an unmatched command is denied or allowed depends on the policy mode below.",
    policyModeLabel: "Command policy",
    policyModeAccept: "Allow-list",
    policyModeProhibited: "Deny-list",
    policyModeAcceptDescription: "Only the commands listed below are allowed — everything else is denied.",
    policyModeProhibitedDescription: "Every command is allowed except the ones listed below.",
    policyModeToggleFailed: "Failed to change the command policy",
